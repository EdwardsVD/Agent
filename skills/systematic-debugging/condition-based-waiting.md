...
// [PASS] AFTER: Waiting for condition
...
**[PASS] Fix:** Poll every 10ms

**[FAIL] No timeout:** Loop forever if condition never met
**[PASS] Fix:** Always include timeout with clear error

**[FAIL] Stale data:** Cache state before loop
**[PASS] Fix:** Call getter inside loop for fresh data
